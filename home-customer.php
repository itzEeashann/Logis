        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <p>Fill In the Info Below to Book your Ride!</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-7" class="php-email-form">
            <form action="booking.php" method="post" class="php-email-form">
              ...
              <p>Enter the Information below to book your ride!</p>
              <div class="row gy-4">
                <div class="col-md-6">
                  <input type="text" name="departure" class="form-control" placeholder="Departure Location" required>
                </div>
                ...
                <div class="col-md-6">
                  <input type="text" name="weight" class="form-control" placeholder="Total Number of Passenger" required>
                </div>

                <div class="col-md-6">
                  <input type="text" name="price" class="form-control" placeholder="Enter your Price" required>
                </div>
                ...
                <div class="col-md-12 ">
                  <input type="text" class="form-control" name="gender" placeholder="Email" value="<?php echo $row['gender'];?>">
                </div>
                ...
                <div class="col-md-12">
                  <textarea class="form-control" name="message" rows="6" placeholder="Any Remark to Rider?" required></textarea>
                </div>
