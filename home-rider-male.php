...
<body>
   ...
   <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="home-rider-male.php" class="logo d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="home-rider-male.php" class="active">Home</a></li>
  ...
  <main id="main">
    ...
    <?php
      ...
      $query = "SELECT * FROM booking WHERE status='pending' AND gender='male'";
    ...
    <section id="horizontal-pricing" class="horizontal-pricing pt-0">
      <div class="container" data-aos="fade-up">
        <div class="row gy-4 pricing-item featured mt-4" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-3 d-flex align-items-center justify-content-center">
          <form action="accept.php" <?php echo $row['id']; ?> method="POST">
    ...
    <?php
      include_once('conn.php');
      $query = "SELECT * FROM booking WHERE status='ongoing' AND gender='male' AND ridername = '{$_SESSION['username']}'";
      $result = mysqli_query($conn, $query);
    ?>
    <br>
    <br>
    ...
    <section id="horizontal-pricing" class="horizontal-pricing pt-0">
      ...
      <?php
      include_once('conn.php');
      $query = "SELECT * FROM booking WHERE status='finish' AND gender='male' AND ridername = '{$_SESSION['username']}'";
      $result = mysqli_query($conn, $query);
    ?>
    <div class="section-header">
    ...
    <section id="horizontal-pricing" class="horizontal-pricing pt-0">
      <div class="container" data-aos="fade-up">
        <div class="row gy-4 pricing-item featured mt-4" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-3 d-flex align-items-center justify-content-center">
            <div class="text-center"><a href="delete.php?id=<?php echo $row["id"]; ?>" class="buy-btn">Delete?</a></div>
        </div><!-- End Pricing Item -->
      </div>
      <?php  
        }
